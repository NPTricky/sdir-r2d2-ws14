...
{
  morekeywords=[1]{return, if, else, true, false}, %
  morekeywords=[2]{multiplyMatrix, inverseOf, isCollinear, isWristSingularity, isOverheadSingularity}, %
  morekeywords=[3]{m_t4, m_t5, m_t6, m_ta1, m_ta2, m_ta3, m_ta4, m_tcp, m_tool}, %
  sensitive=false, %
  morecomment=[l]{//}, %
  morecomment=[s]{/*}{*/}, %
}
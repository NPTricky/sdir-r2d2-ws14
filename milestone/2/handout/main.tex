...
\lstinputlisting[language=pseudo,style=global,caption={pseudocode for determine the configuration from the inverse kinematic, variant 2},label=lst:selectConfiguration_variant_2]{selectConfiguration_variant2.pseudo}
\end{frame}

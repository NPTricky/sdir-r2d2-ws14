...
\begin{figure}[h]
  \includegraphics[height=0.8\textheight]{2/velocity-profile.png}
...
\begin{frame}
  \begin{figure}[h]
    \includegraphics[width=\textwidth]{2/acceleration-profile.png}
...
\item \textcolor{Dandelion}{case 2}: \emph{constant movement phase} $t_{a} < t \leq t_{e} - t_{a}$
\item \textcolor{red}{case 3}: \emph{deceleration phase} $t_{e} - t_{a} < t \leq t_{e}$
\item \textcolor{blue}{case 4}: \emph{stood phase} $t_{e} < t$
\end{itemize}
...
v_{m,i} \cdot t - \frac{1}{2} \cdot \frac{v_{m,i}^2}{\hat{a}_{m,i}} & t_{a,i} < t \leq t_{e,i} - t_{a,i} \\
v_{m,i} \cdot (t_{e,i} - t_{a,i}) - \frac{\hat{a}_{m,i}}{2} \cdot (t_{e,i} - t)^2 & t_{e,i} - t_{a,i} < t \leq t_{e,i}\\
...
i & 0 & 1 & 2 & 3 \\
\midrule
$\Theta_{t_{0},i}$ & $  0^\circ$ & $20^\circ$ & $30^\circ$ & $-20^\circ$ \\ 
$\Theta_{t_{e},i}$ & $ 64^\circ$ & $11^\circ$ & $46^\circ$ & $  5^\circ$ \\
\bottomrule
\end{tabular}
\end{center}
\end{frame}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$t \leq t_{a,i}$ & true & true & true & true \\
\bottomrule
\end{tabular}
\end{center}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$X_{i}(t)$      & 0.125 & 0.125  & 0.125  & 0.125 \\
$\Theta_{i}(t)$ & 0.125 & 19.875 & 30.125 & -19.875\\
\bottomrule
\end{tabular}
\end{center}
\end{frame}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$t_{a,i} < t \leq t_{e,i} - t_{a,i}$ & false & true & true & true \\
\bottomrule
\end{tabular}
\end{center}
...
i & 1 & 2 & 3 \\
\midrule
$X_{i}(t)$      & $4.5^\circ$  & $8.0^\circ$  & $12.5^\circ$ \\ 
$\Theta_{i}(t)$ & $15.5^\circ$ & $38.0^\circ$ & $-7.5^\circ$ \\
\bottomrule
\end{tabular}
\end{center}
\end{frame}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$t_{e,i} - t_{a,i} < t \leq t_{e,i}$ & true  & true & true & true \\
\bottomrule 
\end{tabular}
\end{center}
...
\begin{equation*}
X_{i}(t)=v_{m,i} \cdot (t_{e,i} - t_{a,i}) - \frac{\hat{a}_{m,i}}{2} \cdot (t_{e,i} - t)^2  
\end{equation*}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$X_{i}(t)$      & $63.9^\circ$ & $8.8^\circ$ & $15.2^\circ$ & $24.8^\circ$ \\
$\Theta_{i}(t)$ & $63.9^\circ$ & $11.2^\circ$ & $45.2^\circ$ & $4.8^\circ$ \\
\bottomrule
\end{tabular}
\end{center} 
\end{frame}
...
\begin{frame}
  in the \emph{stood phase} $t = 1.8s$
  ...
  \begin{center}
    \begin{tabular}{ccccc}
      ...
      i & 0 & 1 & 2 & 3 \\
      \midrule
      $t_{e,i} < t$ & true  & true & true & true \\
      \bottomrule 
    \end{tabular}
  \end{center}
  
  all axis are in the stood phase\\
  for the stood phase, we take the following formula
  ...
  \begin{center}
    \begin{tabular}{ccccc}
      ...
      i & 0 & 1 & 2 & 3 \\
      \midrule
      $X_{i}(t)$      & $64.0^\circ$ & $9.0^\circ$ & $16.0^\circ$ & $25.0^\circ$ \\
      $\Theta_{i}(t)$ & $64.0^\circ$ & $11^\circ$ & $46.0^\circ$ & $5.0^\circ$ \\
      \bottomrule
    \end{tabular}
  \end{center} 
\end{frame}

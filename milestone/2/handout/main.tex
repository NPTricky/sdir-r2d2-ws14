...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textcolor{blue}{case 4}: \emph{standstill phase} $t_{e} < t$
  \end{itemize}
\end{frame}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$t_{a,i} < t \leq t_{d,i}$ & false & true & true & true \\
\bottomrule
\end{tabular}
\end{center}
...
i & 0 & 1 & 2 & 3 \\
\midrule
$t_{d,i} < t \leq t_{e,i}$ & true  & true & true & true \\
\bottomrule 
\end{tabular}
\end{center}
...
\begin{frame}
  in the \emph{standstill phase} $t = 1.8s$
  ...
  all axis are in the standstill phase\\
  for the standstill phase, we take the following formula
